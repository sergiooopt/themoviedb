...
import 'package:peliculas/core/widgets/slider_popular.dart';
import 'package:peliculas/core/widgets/slider_upcoming.dart';
...
class HomeUpcoming extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: FutureBuilder(
        future: providerTheMovieDB.getUpcoming(),
        builder: (context, snapshot) {
          ...
          return Consumer<ProviderThemoviedb>(
            builder: (BuildContext context, ProviderThemoviedb provider, Widget? child) {
              return SliderUpcoming(
                peliculas: movies,
                cargarSeguintePaxina: provider.getUpcoming,
              );
            },
          );
        },
