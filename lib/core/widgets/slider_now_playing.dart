...
class SliderNowPlaying extends StatefulWidget {
  ...
  @override
  State<SliderNowPlaying> createState() => _MovieSliderState();
}

class _MovieSliderState extends State<SliderNowPlaying> {
